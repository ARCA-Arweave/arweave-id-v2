 ...
 */
export declare function get(address: string, arweaveInstance: Arweave): Promise<ArweaveId>;
/**
 ...
 * @param arweaveInstance an instance of the Arweave object
 */
export declare function set(arweaveIdData: ArweaveId, jwk: JWKInterface, arweaveInstance: Arweave): Promise<ISetReturn>;
/**
 ...
 */
export declare function check(name: string, arweaveInstance: Arweave): Promise<string>;
/**
